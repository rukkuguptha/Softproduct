...
-(void)CustomerMasterselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomerMasterselect xmlns=\"http://test1.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/CustomerMasterselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)CustomerMasterInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomerMasterInsert xmlns=\"http://test1.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/CustomerMasterInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)CustomerMasterUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomerMasterUpdate xmlns=\"http://test1.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/CustomerMasterUpdate" forHTTPHeaderField:@"Soapaction"];
