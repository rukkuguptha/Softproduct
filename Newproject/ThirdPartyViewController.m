...
-(void)SelectAllSubtypeThirdParty{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllSubtypeThirdParty xmlns=\"http://test1.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/SelectAllSubtypeThirdParty" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectAllThirdParty{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllThirdParty xmlns=\"http://test1.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/SelectAllThirdParty" forHTTPHeaderField:@"Soapaction"];
...
-(void)InsertThirdParty{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertThirdParty xmlns=\"http://test1.kontract360.com/\">\n"
                   "<ItemCode>%@</ItemCode>\n"
                    "<unitcost>%f</unitcost>\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/InsertThirdParty" forHTTPHeaderField:@"Soapaction"];
...
-(void)UpdateThirdParty {
   ...
   Equpmntmdl*Thrdprty=(Equpmntmdl *)[_thirdprtyarray objectAtIndex:path];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateThirdParty  xmlns=\"http://test1.kontract360.com/\">\n"
                   "<entryid>%d</entryid>\n"
                   "<ItemCode>%@</ItemCode>\n"
                     "<unitcost>%f</unitcost>\n"
                   "<Description>%@</Description>\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/UpdateThirdParty" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteThirdParty{
   ...
   Equpmntmdl*eqmdl=(Equpmntmdl *)[_thirdprtyarray objectAtIndex:deltepath];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteThirdParty xmlns=\"http://test1.kontract360.com/\">\n"
                   "<entryid>%d</entryid>\n"
                   "</DeleteThirdParty>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",eqmdl.entryid];
    ...
    [theRequest addValue: @"http://test1.kontract360.com/DeleteThirdParty" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchThirdParty {
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchThirdParty  xmlns=\"http://test1.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/SearchThirdParty" forHTTPHeaderField:@"Soapaction"];
...
-(void)UploadAnyImage{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UploadAnyImage xmlns=\"http://test1.kontract360.com/\">\n"
                   "<f>%@</f>\n"
                   "<fileName>%@</fileName>\n"
                   "<type>%@</type>\n"
                   "<itemcode>%@</itemcode>\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/UploadAnyImage" forHTTPHeaderField:@"Soapaction"];
...
-(void)FetchAnyImage{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<FetchAnyImage xmlns=\"http://test1.kontract360.com/\">\n"
                   "<filename>%@</filename>\n"
                   "<type1>%@</type1>\n"
                   "</FetchAnyImage>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/FetchAnyImage" forHTTPHeaderField:@"Soapaction"];
...
-(void)AllSkills{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<AllSkills xmlns=\"http://test1.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test1.kontract360.com/AllSkills" forHTTPHeaderField:@"Soapaction"];
