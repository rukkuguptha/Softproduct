...
-(void)ScaffoldingSelectScaffoldtype{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ScaffoldingSelectScaffoldtype xmlns=\"http://test2.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test2.kontract360.com/ScaffoldingSelectScaffoldtype" forHTTPHeaderField:@"Soapaction"];
...
-(void)ScaffoldingSelectplan{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ScaffoldingSelectplan xmlns=\"http://test2.kontract360.com/\">\n"
                    "<planid>%@</planid>\n"
    ...
    [theRequest addValue: @"http://test2.kontract360.com/ScaffoldingSelectplan" forHTTPHeaderField:@"Soapaction"];
