...
-(void)SelectAllfleet{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllfleet xmlns=\"http://test2.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test2.kontract360.com/SelectAllfleet" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectAllSubtypefleet{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllSubtypefleet xmlns=\"http://test2.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test2.kontract360.com/SelectAllSubtypefleet" forHTTPHeaderField:@"Soapaction"];
...
-(void)Insertfleet{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Insertfleet xmlns=\"http://test2.kontract360.com/\">\n"
                   "<ItemCode>%@</ItemCode>\n"
    ...
    [theRequest addValue: @"http://test2.kontract360.com/Insertfleet" forHTTPHeaderField:@"Soapaction"];
...
-(void)Updatefleet{
  ...
  Equpmntmdl*eqmdl=(Equpmntmdl *)[_fleetarray objectAtIndex:path];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Updatefleet xmlns=\"http://test2.kontract360.com/\">\n"
                   "<ItemCode>%@</ItemCode>\n"
                   "<Description>%@</Description>\n"
                   "<SubType>%@</SubType>\n"
                   "<PurchaseValue>%f</PurchaseValue>\n"
    ...
    [theRequest addValue: @"http://test2.kontract360.com/Updatefleet" forHTTPHeaderField:@"Soapaction"];
...
-(void)Deletefleet{
  ...
  Equpmntmdl*eqmdl=(Equpmntmdl *)[_fleetarray objectAtIndex:deltepath];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Deletefleet xmlns=\"http://test2.kontract360.com/\">\n"
                   "<entryid>%d</entryid>\n"
                   "</Deletefleet>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",eqmdl.entryid];
    ...
    [theRequest addValue: @"http://test2.kontract360.com/Deletefleet" forHTTPHeaderField:@"Soapaction"];
...
-(void)Searchfleet{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Searchfleet xmlns=\"http://test2.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test2.kontract360.com/Searchfleet" forHTTPHeaderField:@"Soapaction"];
